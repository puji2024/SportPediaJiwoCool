...
internal enum L10n {
  ...
  internal enum Teams {
    ...
    /// Urutkan
    internal static let sort = L10n.tr("Localizable", "teams.sort", fallback: "Urutkan")
    /// SportsPedia
    internal static let title = L10n.tr("Localizable", "teams.title", fallback: "SportsPedia")
    internal enum Sort {
      /// Negara
      internal static let country = L10n.tr("Localizable", "teams.sort.country", fallback: "Negara")
      /// Nama tim
      internal static let name = L10n.tr("Localizable", "teams.sort.name", fallback: "Nama tim")
    }
