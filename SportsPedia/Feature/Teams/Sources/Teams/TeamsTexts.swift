...
enum TeamsTexts {
    ...
    static func established(_ year: String) -> String {
        CommonLocalization.formatted("detail.established", fallback: "Est. %@", year)
    }
    static func logo(_ name: String) -> String {
        CommonLocalization.formatted("detail.logo", fallback: "Logo %@", name)
    }
}
